...
module.exports = function (deployer) {
  deployer.deploy(Off, 'Off', 'OFF', web3.utils.toWei('35'))
    .then(async (off) => {
      ...
      await off.mint(2, false, 'QmYzqt8s6Xmv8HtDdQ69zyfpcQdx89Gi8bnUmEZ4AHrT6z', 'QmYzqt8s6Xmv8HtDdQ69zyfpcQdx89Gi8bnUmEZ4AHrT6z', 'QmaNEWataLJrRPr6WF7yqgaj4yT6VQYufBnM15HVXepwCh');
    });
};
